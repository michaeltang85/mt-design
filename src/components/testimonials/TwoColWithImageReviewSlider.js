...
const ControlButton = styled(PrimaryButton)`
  ${tw`mx-3 rounded-full text-gray-100 p-2 bg-blue-500 hocus:bg-blue-700`}
  svg {
    ${tw`w-5 h-5`}
  }
`;
...
const HeadingTitle = tw(SectionHeading)`lg:text-left leading-tight text-blue-700`;
...
export default ({
    ...
    description = "Here are what some of our customers are saying about our designs. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    testimonials = null,
    textOnLeft = false
  }) => {
    /*
    ...
    const defaultTestimonials = [
      {
        imageSrc:
          "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1024&q=80",
        profileImageSrc:
          "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.25&w=512&h=512&q=80",
        quote:
          "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.",
        customerName: "Jane Doe",
        customerTitle: "CEO, Happy Inc."
      },
      {
        imageSrc:
          "https://images.unsplash.com/photo-1554435493-93422e8220c8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1024&q=80",
        profileImageSrc:
          "https://images.unsplash.com/photo-1590735627513-59a186ed0984?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.25&w=512&h=512&q=80",
        quote:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        customerName: "John Doe",
        customerTitle: "Founder, Resonance"
      }
    ];
