...
const Container = tw(ContainerBase)`bg-blue-900 text-gray-100 -mx-8 px-8`;
    ...
    const defaultPlans = [
        {
            ...
            price: ["19",".99/month"],
            oldPrice: "",
            description: "Nunc posuere purus rhoncus pulvinar aliquam.",
            features: ["Community Support", "Email Support"],
            url: "#"
        },
        {
            name: "Business",
            price: ["39",".99/month"],
            oldPrice: "",
            description: "Ut aliquet tristique nisl vitae volutpat. Nulla aliquet porttitor venenatis.",
            features: ["Community Support", "Email Support", "Chat Support "],
            url: "#"
        },
        {
            name: "Enterprise",
            price: ["99",".99/month"],
            oldPrice: "",
            description: "Duis sit amet sodales felis. Duis nunc eros, mattis at dui ac, convallis semper risus.",
            features: ["Community Support", "Email Support", "Chat Support", "Phone Support", "Team of Service Success Representatives"],
            url: "#"
        }
    ];
